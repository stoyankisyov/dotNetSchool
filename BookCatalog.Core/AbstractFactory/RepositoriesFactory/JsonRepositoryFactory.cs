...
{
    public class JsonRepositoryFactory : RepositoryAbstractFactory
    {

        public JsonRepositoryFactory(IGenericRepository<Catalog<EBook>> eBookRepository, IGenericRepository<Catalog<PaperBook>> paperBookRepository)
